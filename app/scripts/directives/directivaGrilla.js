...
.directive('directivaFila',function(){
	...
	return {/*
			...
			template: '<td ng-bind="row.nombre"></td><td ng-bind="row.correo"></td><td ng-bind="row.tipo"></td><td><button class="btn btn-default" type="submit" ng-click="borrar(row.id)">Borrar</button></td>'
